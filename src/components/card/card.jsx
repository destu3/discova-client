...
const Card = ({ anime }) => {
  ...
  return (
    <div className="aspect-[37/53] w-full h-full relative rounded-[4px] overflow-hidden">
      <Link
      ...
      >
        <img
          className="absolute top-0 left-0 h-full w-full object-cover rounded-[4px] poster transition-all duration-[400ms]"
      ...
      {!posterLoaded && (
        <Skeleton className="absolute top-0 left-0 bottom-0 right-0 rounded-[4px] bg-[var(--overlay-grey)] img-skeleton overflow-hidden z-30 justify-center items-center" />
      )}
